...
class PaperTradingSetting(Base):
    ...
    enable_breakout_quality: Mapped[bool] = mapped_column(Boolean, nullable=False, default=True, server_default="TRUE")
    minimum_close_position_percent: Mapped[float] = mapped_column(Float, nullable=False, default=80.0, server_default="80.0")
    minimum_candle_body_percent: Mapped[float] = mapped_column(Float, nullable=False, default=60.0, server_default="60.0")
    maximum_rejection_wick_percent: Mapped[float] = mapped_column(Float, nullable=False, default=20.0, server_default="20.0")
    minimum_close_beyond_level_ticks: Mapped[float] = mapped_column(Float, nullable=False, default=2.0, server_default="2.0")
    require_volume_confirmation: Mapped[bool] = mapped_column(Boolean, nullable=False, default=True, server_default="TRUE")
